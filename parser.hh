...
/**
 ** \file /home/user/naive-minijava-interpreter/parser.hh
...
#ifndef YY_YY_HOME_USER_NAIVE_MINIJAVA_INTERPRETER_PARSER_HH_INCLUDED
# define YY_YY_HOME_USER_NAIVE_MINIJAVA_INTERPRETER_PARSER_HH_INCLUDED
...
#line 54 "/home/user/naive-minijava-interpreter/parser.hh"
...
namespace yy {
#line 188 "/home/user/naive-minijava-interpreter/parser.hh"
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_END || tok == token::TOK_NEW || tok == token::TOK_CLASS || tok == token::TOK_PUBLIC || tok == token::TOK_STATIC || tok == token::TOK_VOID || tok == token::TOK_MAIN || tok == token::TOK_LCURLPAREN || tok == token::TOK_RCURLPAREN || tok == token::TOK_SEMICOLON || tok == token::TOK_LENGTH || tok == token::TOK_PRINT || tok == token::TOK_ASSERT || tok == token::TOK_INT || tok == token::TOK_BOOLEAN || tok == token::TOK_LSQPAREN || tok == token::TOK_RSQPAREN || tok == token::TOK_ASSIGN || tok == token::TOK_EXCL || tok == token::TOK_AND || tok == token::TOK_OR || tok == token::TOK_LESS || tok == token::TOK_MORE || tok == token::TOK_EQUAL || tok == token::TOK_MINUS || tok == token::TOK_PLUS || tok == token::TOK_STAR || tok == token::TOK_SLASH || tok == token::TOK_PERC || tok == token::TOK_DOT || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_TRUE || tok == token::TOK_FALSE);
      }
#else
...
#line 1783 "/home/user/naive-minijava-interpreter/parser.hh"





#endif // !YY_YY_HOME_USER_NAIVE_MINIJAVA_INTERPRETER_PARSER_HH_INCLUDED
