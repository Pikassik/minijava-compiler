...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // ClassMembers
      char dummy2[sizeof (pair<vector<ptr<MethodDeclaration>>, vector<ptr<VarDeclaration>>>)];

      // BooleanLiteral
      char dummy3[sizeof (ptr<BooleanLiteral>)];

      // MainClassDeclaration
      // ClassDeclaration
      char dummy4[sizeof (ptr<Class>)];

      // Expression
      char dummy5[sizeof (ptr<Expression>)];

      // Lvalue
      char dummy6[sizeof (ptr<Lvalue>)];

      // MethodDeclaration
      char dummy7[sizeof (ptr<MethodDeclaration>)];

      // MethodInvocation
      char dummy8[sizeof (ptr<MethodInvocation>)];

      // SignedNumber
      char dummy9[sizeof (ptr<Number>)];

      // Program
      char dummy10[sizeof (ptr<Program>)];

      // Scope
      char dummy11[sizeof (ptr<Scope>)];

      // Statement
      char dummy12[sizeof (ptr<Statement>)];
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, pair<vector<ptr<MethodDeclaration>>, vector<ptr<VarDeclaration>>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const pair<vector<ptr<MethodDeclaration>>, vector<ptr<VarDeclaration>>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ptr<BooleanLiteral>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ptr<BooleanLiteral>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ptr<MethodDeclaration>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ptr<MethodDeclaration>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ptr<MethodInvocation>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ptr<MethodInvocation>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ptr<Number>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ptr<Number>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ptr<Scope>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ptr<Scope>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, vector<ptr<Expression>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const vector<ptr<Expression>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    {
      ...
      case 49: // ClassMembers
        value.template destroy< pair<vector<ptr<MethodDeclaration>>, vector<ptr<VarDeclaration>>> > ();
        break;

      case 65: // BooleanLiteral
        value.template destroy< ptr<BooleanLiteral> > ();
        break;
      ...
      case 50: // MethodDeclaration
        value.template destroy< ptr<MethodDeclaration> > ();
        break;

      case 61: // MethodInvocation
        value.template destroy< ptr<MethodInvocation> > ();
        break;

      case 66: // SignedNumber
        value.template destroy< ptr<Number> > ();
        break;
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_LCURLPAREN (location_type l)
      {
        return symbol_type (token::TOK_LCURLPAREN, std::move (l));
      }
#else
      static
      symbol_type
      make_LCURLPAREN (const location_type& l)
      {
        return symbol_type (token::TOK_LCURLPAREN, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RCURLPAREN (location_type l)
      {
        return symbol_type (token::TOK_RCURLPAREN, std::move (l));
      }
#else
      static
      symbol_type
      make_RCURLPAREN (const location_type& l)
      {
        return symbol_type (token::TOK_RCURLPAREN, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LSQPAREN (location_type l)
      {
        return symbol_type (token::TOK_LSQPAREN, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_LSQPAREN, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RSQPAREN (location_type l)
      {
        return symbol_type (token::TOK_RSQPAREN, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_RSQPAREN, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (std::move (that.location))
  {
    switch (this->type_get ())
    {
      ...
      case 49: // ClassMembers
        value.move< pair<vector<ptr<MethodDeclaration>>, vector<ptr<VarDeclaration>>> > (std::move (that.value));
        break;

      case 65: // BooleanLiteral
        value.move< ptr<BooleanLiteral> > (std::move (that.value));
        break;
      ...
      case 50: // MethodDeclaration
        value.move< ptr<MethodDeclaration> > (std::move (that.value));
        break;

      case 61: // MethodInvocation
        value.move< ptr<MethodInvocation> > (std::move (that.value));
        break;

      case 66: // SignedNumber
        value.move< ptr<Number> > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    switch (this->type_get ())
    {
      ...
      case 49: // ClassMembers
        value.copy< pair<vector<ptr<MethodDeclaration>>, vector<ptr<VarDeclaration>>> > (YY_MOVE (that.value));
        break;

      case 65: // BooleanLiteral
        value.copy< ptr<BooleanLiteral> > (YY_MOVE (that.value));
        break;
      ...
      case 50: // MethodDeclaration
        value.copy< ptr<MethodDeclaration> > (YY_MOVE (that.value));
        break;

      case 61: // MethodInvocation
        value.copy< ptr<MethodInvocation> > (YY_MOVE (that.value));
        break;

      case 66: // SignedNumber
        value.copy< ptr<Number> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->type_get ())
    {
      ...
      case 49: // ClassMembers
        value.move< pair<vector<ptr<MethodDeclaration>>, vector<ptr<VarDeclaration>>> > (YY_MOVE (s.value));
        break;

      case 65: // BooleanLiteral
        value.move< ptr<BooleanLiteral> > (YY_MOVE (s.value));
        break;
      ...
      case 50: // MethodDeclaration
        value.move< ptr<MethodDeclaration> > (YY_MOVE (s.value));
        break;

      case 61: // MethodInvocation
        value.move< ptr<MethodInvocation> > (YY_MOVE (s.value));
        break;

      case 66: // SignedNumber
        value.move< ptr<Number> > (YY_MOVE (s.value));
        break;
